                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a 
                                ...
                                className="w-12 h-12 flex items-center justify-center rounded-full border border-border text-secondary hover:bg-primary hover:text-background hover:border-primary transition-all duration-300 group"
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full px-4 py-3 rounded-lg bg-background border ${errors.name ? 'border-red-500 focus:border-red-500' : 'border-border focus:border-primary'} text-primary focus:outline-none transition-colors placeholder-gray-500`}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full px-4 py-3 rounded-lg bg-background border ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-border focus:border-primary'} text-primary focus:outline-none transition-colors placeholder-gray-500`}
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={handleChange}
                            rows={4}
                            className={`w-full px-4 py-3 rounded-lg bg-background border ${errors.message ? 'border-red-500 focus:border-red-500' : 'border-border focus:border-primary'} text-primary focus:outline-none transition-colors resize-none placeholder-gray-500`}
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-primary text-background font-bold rounded-lg hover:opacity-90 transition-all transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-primary/10"
                    >
                        {isSubmitting ? (
                 ...
                 <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl -z-0 pointer-events-none transform translate-x-1/2 -translate-y-1/2"></div>
            </div>
        </div>
