        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
           <div className="mb-6 md:mb-0">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-bold uppercase tracking-wider text-secondary">Life behind code</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-white">@munawirfikri</h2>
           </div>
           ...
           <a 
             ...
             className="inline-flex items-center gap-2 text-sm font-semibold text-white hover:text-gray-300 transition-colors pb-1 border-b border-white hover:border-gray-300"
           >
